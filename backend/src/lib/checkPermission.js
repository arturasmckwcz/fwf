const Member = require('../model/members/members.model')
const Role = require('../model/roles/roles.model')
const Right = require('../model/rights/rights.model')
const Permission = require('../model/permissions/permissions.model')
