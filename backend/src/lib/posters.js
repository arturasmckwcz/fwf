...
async function insertPerson(person) {
  ...
  try {
    const result = await Person.query().insert(person)
    return result
  } catch (error) {
...
async function insertPatient(patient) {
  ...
  try {
    const result = await Patient.query().insert(patient)
    return result
  } catch (error) {
...
async function insertPresciption(prescription) {
  ...
  try {
    const result = await Prescription.query().insert(prescription)
    return result
  } catch (error) {
...
async function insertSource(source) {
  console.log('insertSource source:\n', source)
  try {
    const result = await Source.query().insert(source)
    return result
  } catch (error) {
    console.log('insertSource went wrong: ', error)
    return error
  }
}
...
async function insertProduction(production) {
  ...
  try {
    const result = await Production.query().insert(production)
    return result
  } catch (error) {
